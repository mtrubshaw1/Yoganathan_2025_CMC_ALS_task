...
is_bursts = np.load('data/is_bursts_emg.npy',allow_pickle=True)
betas = np.load('data/psd_tf_betas_range_emg.npy',allow_pickle=True)
...
plt.savefig('plots/burst_prob_tc_emg.png', dpi=300)
plt.show()
